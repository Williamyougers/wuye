...
<div class="ch-container">
    ...
    <c:forEach var="house" items="${houses}" >
		<tr>
			...
			<td>${house.memo}</td>
	        <td class="center">
	            <a class="btn btn-info" href="/house/findById?id=${house.id}">
	                <i class="glyphicon glyphicon-edit icon-white"></i>
	                编&ensp;辑
	            </a>
	            <a class="btn btn-danger" href="/house/Delete" data-href="/house/houseDelete?id=${house.id}" data-toggle="modal" data-target="#myModal">
