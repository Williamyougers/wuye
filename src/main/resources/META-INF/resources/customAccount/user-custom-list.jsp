    ...
    <div class="navbar-inner">
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu">
                <li><a href="customAccount/logout">注销登录</a></li>
            </ul>
        </div>
        <!-- user dropdown ends -->
    </div>
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="customAccount/findById2&accountid=${customAccount.accountid }"><i class="glyphicon glyphicon-user"></i><span> &ensp;业&ensp;主&ensp;信&ensp;息</span></a>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="custom/findById2&accountid=${customAccount.accountid }">业主信息</a>
                    </li>
                </ul>
            </div>
