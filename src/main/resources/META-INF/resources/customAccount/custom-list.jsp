                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                <thead>
                                <a class="btn btn-success" href="custom-add.jsp">
                                ...
                                <c:forEach var="customAccount" items="${customAccounts}" >
									<tr>
										...
										<td class="center">
                                            ...
                                            <a class="btn btn-danger" href="#" data-href="customAccount/customAccountDelete&accountid=${customAccount.accountid}" data-toggle="modal" data-target="#myModal">
