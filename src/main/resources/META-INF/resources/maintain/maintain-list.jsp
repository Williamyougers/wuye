                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="maintain/maintainList"><i class="glyphicon glyphicon-wrench"></i><span> &ensp;报&ensp;修&ensp;管&ensp;理</span></a>
                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                <thead>
                                <a class="btn btn-success" href="maintain-add.jsp">
                                ...
                                <c:forEach var="maintain" items="${maintains}" >
									<tr>
                                        ...
                                        <td class="center">
                                            <a class="btn btn-info" href="maintain/findById&id=${maintain.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="maintain/maintainDelete&id=${maintain.id}" data-toggle="modal" data-target="#myModal">
