...
<head>
    ...
    <!-- The styles -->
    <link href="../static/css/bootstrap-cerulean.min.css" rel="stylesheet" media="screen">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="notice/noticelist"><i class="glyphicon glyphicon-envelope"></i><span> &ensp;公&ensp;告&ensp;管&ensp;理</span></a>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" action="notice/noticeEdit" data-toggle="validator" method="POST">
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="user" value="${notice.uper }" required />
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
