        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="notice/noticelist">公告管理</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                <thead>
                                <a class="btn btn-success" href="notice-add.jsp">
                                ...
                                <c:forEach var="notice" items="${notice}">
							        <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            <a class="btn btn-danger" href="noticeDelete" data-href="/notice/noticeDelete?id=${notice.id}" data-toggle="modal" data-target="#myModal">
