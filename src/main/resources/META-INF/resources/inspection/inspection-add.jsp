...
<div class="ch-container">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="/inspection/inspectionList"><i class="glyphicon glyphicon-info-sign"></i><span> &ensp;保&ensp;安&ensp;保&ensp;洁</span></a>
    ...
    <ul class="breadcrumb">
        	...
        	<li>
            	<a href="/inspection/inspectionAdd">添加</a>
        	</li>
    </ul>
</div>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" data-toggle="validator" action="inspectionAdd" method="post">
				<fieldset>
...
<!-- select odropdown enhancer -->
<script src="/bower_components/chosen/chosen.jquery.min.js"></script>
<!-- plugin f gallery image view -->
<script src="/bower_components/colorbox/jquery.colorbox-min.js"></script>
<!-- notificaon plugin -->
<script src="/js/jquery.noty.js"></script>
<!-- library r making tables responsive -->
<script src="/bower_components/responsive-tables/responsive-tables.js"></script>
<!-- tour plun -->
<script src="/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
<!-- star ratg plugin -->
<script src="/js/jquery.raty.min.js"></script>
<!-- for iOS yle toggle switch -->
<script src="/js/jquery.iphone.toggle.js"></script>
<!-- autogrowg textarea plugin -->
<script src="/js/jquery.autogrow-textarea.js"></script>
<!-- multipleile upload plugin -->
<script src="/js/jquery.uploadify-3.1.min.js"></script>
<!-- history. for cross-browser state change on ajax -->
<script src="/js/jquery.history.js"></script>
<!-- applicatn script for Charisma demo -->
