...
<div class="ch-container">
    ...
    <ul class="breadcrumb">
            ...
            <li>
                <a href="inspection-list.jsp">保安保洁</a>
            </li>
        	<li>
            	<a href="inspection/inspectionEdit">编辑</a>
        	</li>
    </ul>
</div>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" data-toggle="validator" action="inspection/inspectionEdit" method="post">
				<fieldset>
